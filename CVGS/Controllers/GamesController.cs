...
namespace CVGS.Controllers
{
    public class GamesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "gameID,title,description,categoryID,subCategoryID,developer,publisher,releasedDate,createdDate,updatedDate,price")] Game game)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "gameID,title,description,categoryID,subCategoryID,developer,publisher,releasedDate,createdDate,updatedDate,price")] Game game)
        {
            if (ModelState.IsValid)
            {
                game.updatedDate = DateTime.Now;
